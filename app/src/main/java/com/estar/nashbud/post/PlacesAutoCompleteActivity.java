...
import com.estar.nashbud.post.Post.MyReceiver;
...
public class PlacesAutoCompleteActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAutocompleteView = (EditText)findViewById(R.id.autocomplete_search);

        delete=(ImageView)findViewById(R.id.clear_text);
        ...
        mRecyclerView=(RecyclerView)findViewById(R.id.recycler_location);
                        ...
                        placeResult.setResultCallback(new ResultCallback<PlaceBuffer>() {
                            ...
                            public void onResult(PlaceBuffer places) {
                                if(places.getCount()==1){
                                    ...
                                    Intent intnet = new Intent("com.estar.nashbud.USER_ACTION");
                                    intnet.putExtra("GetLocation",String.valueOf(places.get(0).getName()));
                                    intnet.putExtra("GetAddress",String.valueOf(places.get(0).getAddress()));
