...
class ContactsAdapter extends FirebaseRecyclerAdapter<User, ContactsAdapter.UserViewHolder> {

    private final Context context;

    ContactsAdapter(Context context, Query ref) {
        super(User.class, R.layout.contact_raw_data, UserViewHolder.class, ref);
    ...
    public UserViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.contact_raw_data, parent, false);
