...
public class SliderPagerAdapterSendFeedback extends PagerAdapter {
    private LayoutInflater layoutInflater;
    Activity activity;
    ArrayList<ImageModel> image_arraylist= new ArrayList<>();
    String[]mArrayString;

    public SliderPagerAdapterSendFeedback(Activity activity, ArrayList<ImageModel> image_arraylist) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        ImageModel post_model=image_arraylist.get(position);
