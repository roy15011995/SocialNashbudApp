...
public class Photo_GridAdapter extends BaseAdapter {
    ...
    public Photo_GridAdapter(Context ctx, ArrayList<ImageModel>list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        convertView = inflater.inflate(R.layout.photo_grid_row, null);
        holder.image=(ImageView)convertView.findViewById(R.id.image_show_gallery);
...
*/
            ...
            try {
                ...
                Log.e("xyzzzzimage2","" + imageModel.getImagePath());
